# <span><img src="https://github.com/user-attachments/assets/970984fd-bd12-4314-9597-9f9c68c0ed76" width="100" height="25" align='center'/> | <span>간편한 주문 제작 예약 서비스</span>
...
`사업자`는 서비스를 이용하기 위해 간편 소셜 로그인을 통해 서비스에 가입/이용할 수 있습니다.

### [사업자 등록 및 주문서 등록]

| 소셜 로그인 후 초기 화면                                                                                             | 사업자 등록                                                                                                           | 사업자 등록 후                                                                                                       | 주문서 등록 후                                                                                                       |
| -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/user-attachments/assets/e7d15ea2-4e88-421a-8b3d-ac973ace47ca" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/21eb3c5e-c68b-4536-a2d1-74468d4b830b" width="150" height="300s"> | <img src="https://github.com/user-attachments/assets/31b647c1-a3fa-4c19-a8a6-1b2710dc1463" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/91e0e3b3-9f15-4969-a096-c5d749c055f7" width="150" height="300"> |
...
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/user-attachments/assets/703a67de-202a-4af5-89e0-f94a76978442" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/72b9424a-9952-4401-8431-cebc3283c9f8" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/d1788287-83bb-405d-8043-ca362907c826" width="150" height="300"> |
...
| 주문 목록                                                                                                            | 업장 상세                                                                                                            |
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/user-attachments/assets/6706b221-1a03-40b6-bd0f-c2725d040f85" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/a47f6c73-51da-43f2-946d-bff8b3807b27" width="150" height="300"> |

`구매자`는 `사업자`가 설정한 판매 상품을 주문할 수 있습니다. 또한 `사업자`가 판매하는 또 다른 유형의 상품을 구매할수도 있습니다.

### [My 페이지]

| 사업자 등록 필요                                                                                                     | 업장 등록                                                                                                            | 사업자 등록                                                                                                           | 마이페이지(사업자정보)                                                                                               | My 페이지                                                                                                             |
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/user-attachments/assets/ea207bfc-d8de-435e-b0ee-946002f612ab" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/ac8967d7-c0fd-4e64-a2b0-42f98a27f866" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/eedf3fe0-2e21-4a5c-bc65-a5f0297a2b33" width="150" height="300" > | <img src="https://github.com/user-attachments/assets/104ad04a-c038-4cf5-a616-c77f309c4606" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/2d54e06a-3d76-4041-8146-3c811decf54d" width="150" height="300" > |
...
| 주문서 작성1                                                                                                         | 주문서 작성 2                                                                                                        |
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/user-attachments/assets/e8831a90-e426-4efd-92f7-ddf9170f489a" width="150" height="300"> | <img src="https://github.com/user-attachments/assets/42bef107-2500-46cc-a129-022a9690d32d" width="150" height="300"> |
...
`OnlyMe`는 서버와 클라이언트 시스템으로 구성되며 Javascript 와 Nodejs 기반으로 구성되어있습니다.<br>
프로젝트 저장소를 다음 설명에 따라 개발자 컴퓨터에 복사하고 설치 명령을 입력하여 설치를 할 수 있습니다.

```bash
git clone https://github.com/Dev-FE-3/team4-phoenix-CustomService.git my-project
